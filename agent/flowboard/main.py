...
from flowboard.routes import activity, auth, boards, chat, edges, flow_projects, llm, lpv_external, media, nodes, plans, projects, prompt, upload, vision
...
app.include_router(lpv_external.router)
